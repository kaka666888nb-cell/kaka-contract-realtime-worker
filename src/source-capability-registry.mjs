...
const CAPABILITIES = Object.freeze([
  { provider: 'dexscreener', market: 'onchain', capability: 'recent_hot_discovery', official_available: true, official_scope: 'solana_bsc_base_ethereum_latest_profile_plus_top_boost_candidates_rescored_by_market_activity', transport: 'public_REST_fixed_background', batch_mode: 'two_candidate_calls_plus_max_one_30-token_batch_per_chain_per_5m_cycle', rate_limit_class: 'single_global_1200ms_lane_max_50_starts_per_min_below_60_per_min_candidate_limit', collector: 'onchain-market-isolated', target_layer: 'market_onchain_recent_hot', current_integration: 'candidate_step1037_3_token_centric_identity_fix', fallback_policy: 'retain_last_verified_snapshot_30m; user_reads_never_start_discovery_upstream; quote_token_never_inherits_base_token_market_fields', history_policy: 'current_shared_discovery_only', source_url: 'https://docs.dexscreener.com/api/reference' },

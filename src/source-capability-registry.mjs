...
const CAPABILITIES = Object.freeze([
  { provider: 'coinbase', market: 'equity', capability: 'core_cash_equity_candles', official_available: true, official_scope: 'curated_core_US_cash_equities_exact_product_id_only', transport: 'Advanced_Trade_authenticated_REST', batch_mode: 'shared_exact_key_cache_plus_singleflight_core_pool', rate_limit_class: 'bounded_exact_shared', collector: 'exchange-assets-isolated-asset-kline', target_layer: 'asset_kline', current_integration: 'ready_step1035_19', fallback_policy: 'non_core_cash_equities_remain_secondary_source_or_TradingView_display; no cross_ticker/provider/product substitution', history_policy: 'latest_exact_candle_window_per_requested_interval', source_url: 'https://docs.cdp.coinbase.com/api-reference/advanced-trade-api/rest-api/products/get-product-candles' },

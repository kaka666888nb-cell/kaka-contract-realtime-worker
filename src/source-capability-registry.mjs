  ...
  const payload = {
    ...
    step1035_stock_catalog_v2: {
      ready:
        ...
        Number(stockCatalogV2?.coinbase_market?.refresh_successes || 0) > 0 &&
        ...
        Number(stockCatalogV2?.coinbase?.chinese_name_rows || 0) >= 30 &&

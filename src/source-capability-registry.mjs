...
const CAPABILITIES = Object.freeze([
  { provider: 'coinbase', market: 'equity', capability: 'core_cash_equity_candles', official_available: true, official_scope: 'curated_core_US_cash_equities_exact_catalog_product_identity_only', transport: 'Advanced_Trade_public_market_REST_plus_bounded_authenticated_canonical_REST_with_CDP_JWT', batch_mode: 'shared_exact_key_cache_plus_singleflight_core_pool', rate_limit_class: 'bounded_exact_shared', collector: 'exchange-assets-isolated-asset-kline', target_layer: 'asset_kline', current_integration: 'candidate_step1035_19_5_isolated_exchange_assets_core_replica_plus_exact_candle_routes', fallback_policy: 'isolated exchange-assets process warms fixed core Coinbase identities from Supabase read replica; exact opaque product_id+asset_id+ticker guard first; public route uses same-row alias or ticker_quote; one bounded authenticated canonical opaque-id attempt for same product only; non_core locked; no cross_ticker/provider/product substitution', history_policy: 'latest_exact_candle_window_per_requested_interval', source_url: 'https://docs.cdp.coinbase.com/api-reference/advanced-trade-api/rest-api/public/get-public-product-candles' },

...
const CAPABILITIES = Object.freeze([
  { provider: 'dexscreener', market: 'onchain', capability: 'recent_hot_discovery', official_available: true, official_scope: 'solana_bsc_base_ethereum_latest_profile_plus_top_boost_candidates_rescored_by_market_activity', transport: 'public_REST_fixed_background', batch_mode: 'profile_boost_discovery_5m_plus_max_one_30-token_batch_per_chain_per_30s_current_market_refresh', rate_limit_class: 'single_global_1200ms_lane_max_50_starts_per_min_below_documented_limits', collector: 'onchain-market-isolated', target_layer: 'market_onchain_recent_hot', current_integration: 'candidate_step1037_5_shared_near_realtime_metadata', fallback_policy: 'retain_last_verified_snapshot; user_reads_never_start_discovery_or_current-market-refresh_upstream; quote_token_never_inherits_base_token_market_fields', history_policy: 'current_shared_discovery_only', source_url: 'https://docs.dexscreener.com/api/reference' },
  { provider: 'dexscreener', market: 'onchain', capability: 'token_search_and_exact_token_pools', official_available: true, official_scope: 'solana_bsc_base_ethereum_public_pairs_exact_contract_identity', transport: 'public_REST_bounded_backend_queue', batch_mode: 'same_query_or_exact_chain_contract_cache_singleflight', rate_limit_class: 'same_single_global_1200ms_lane_fixed_independent_of_user_count', collector: 'onchain-market-isolated', target_layer: 'market_onchain_search_token_pool', current_integration: 'candidate_step1037_3_token_centric_identity_fix', fallback_policy: 'stale_verified_cache; exact_contract_identity; unknown_same_symbol_never_substitutes; quote_token_market_fields_fail_closed', history_policy: 'current_pair_market_snapshot_only', source_url: 'https://docs.dexscreener.com/api/reference' },
  { provider: 'kaka_backend', market: 'onchain', capability: 'onchain_fault_isolation_and_bounded_shared_reads', official_available: true, official_scope: 'dedicated_onchain_child_process_port_10016_with_160MB_old_space_cap', transport: 'isolated_child_process_plus_parent_short_shared_response_cache', batch_mode: 'background_discovery_fixed_cadence_plus_bounded_exact_build_queues', rate_limit_class: 'user_count_cannot_increase_provider_request_rate_above_fixed_backend_schedulers', collector: 'collector-isolation-supervisor', target_layer: 'backend_runtime', current_integration: 'candidate_step1036', fallback_policy: 'onchain_role_scoped_restart_does_not_restart_market_light_liquidation_deep_market_exchange_assets; queue_overflow_fails_closed', history_policy: 'bounded_memory_only_step1036', source_url: 'internal_architecture' },
  { provider: 'ecb', market: 'onchain', capability: 'secondary_display_fx_reference', official_available: true, official_scope: 'daily_ECB_reference_rates_CNY_JPY_EUR_crossed_from_EUR_base_to_USD_base', transport: 'official_XML_fixed_background_6h', batch_mode: 'one_shared_background_reference_snapshot', rate_limit_class: 'user_reads_zero_upstream;96h_verified_retention_for_weekends_and_TARGET_closures', collector: 'onchain-market-isolated', target_layer: 'app_secondary_price_reference', current_integration: 'candidate_step1037_5', fallback_policy: 'verified_device_or_backend_cache_only;missing_rate_hidden;never_fake_fixed_fx', history_policy: 'latest_official_reference_observation_only', source_url: 'https://www.ecb.europa.eu/stats/policy_and_exchange_rates/euro_reference_exchange_rates/html/index.en.html' },
  { provider: 'moralis', market: 'onchain', capability: 'exact_pool_ohlcv_history', official_available: true, official_scope: 'solana_bsc_base_ethereum_pair_ohlcv_with_exact_chain_token_pool_preflight', transport: 'backend_secret_REST_bounded_scheduler', batch_mode: 'same_exact_pool_interval_window_cache_singleflight', rate_limit_class: '30000_CU_per_UTC_day_backend_hard_budget_below_current_40000_free_plan_reference;150_CU_per_upstream_candlestick_call', collector: 'onchain-market-isolated', target_layer: 'market_onchain_native_kline', current_integration: 'candidate_step1037', fallback_policy: 'verified_stale_cache_only; identity_not_proven_fails_closed; no_cross_pool_or_token_substitution', history_policy: 'exact_pool_time_window_with_backend_cache;15m_same_pool_5m_aggregation', source_url: 'https://docs.moralis.com/data-api/evm/price/ohlc' },
  { provider: 'moralis', market: 'onchain', capability: 'exact_pool_recent_swaps', official_available: true, official_scope: 'solana_bsc_base_ethereum_pair_swaps_with_exact_chain_token_pool_preflight', transport: 'backend_secret_REST_bounded_scheduler', batch_mode: 'same_exact_pool_cache_singleflight', rate_limit_class: 'shares_same_backend_CU_budget;50_CU_per_upstream_pair_swap_call', collector: 'onchain-market-isolated', target_layer: 'market_onchain_recent_trades', current_integration: 'candidate_step1037_2_pair_swap_schema_fixed', fallback_policy: 'verified_stale_cache_only; no_cross_pool_substitution', history_policy: 'recent_swap_rows_only_step1037', source_url: 'https://docs.moralis.com/data-api/evm/token/swaps/pair-swaps' },
  { provider: 'coinbase', market: 'equity', capability: 'core_cash_equity_candles', official_available: false, official_scope: 'runtime_probe_closed', transport: 'none', batch_mode: 'none', rate_limit_class: 'none', collector: 'none', target_layer: 'asset_kline', current_integration: 'closed_step1035_19_6_after_real_runtime_probe', fallback_policy: 'cash equity stays exact; App may explicitly open a labelled Bitget Reality rToken reference product; never hidden substitution', history_policy: 'none', source_url: 'https://docs.cdp.coinbase.com/api-reference/advanced-trade-api/rest-api/public/get-public-product-candles' },
  { provider: 'bitget', market: 'spot', capability: 'reality_stock_token_reference_kline', official_available: true, official_scope: 'all_current_online_SPOT_instruments_with_isReality_yes_dynamic_catalog', transport: 'public_REST_instruments_plus_public_REST_candles_history_candles', batch_mode: 'one_background_full_SPOT_instruments_request_per_hour_plus_exact_rToken_kline_shared_cache_singleflight_on_demand', rate_limit_class: 'catalog_1_per_hour_kline_bounded_exact_under_official_20_per_sec_IP', collector: 'exchange-assets-isolated-asset-kline', target_layer: 'asset_kline_reference', current_integration: 'candidate_step1035_19_6_dynamic_all_reality', fallback_policy: 'explicit reference only; preserve exact bitget rToken product identity; unknown cash ticker never guesses; no hidden cross-provider/product substitution', history_policy: 'official_market_1m_5m_15m_1H_4H_1D_history', source_url: 'https://www.bitget.com/api-doc/uta/reality-trading-guide' },
  { provider: 'kaka_backend', market: 'shared', capability: 'stock_catalog_v2_full_i18n_security_session', official_available: true, official_scope: 'Gate_full_us_hk_kr_cash_stock_ETF_plus_Coinbase_full_equity_cursor_catalog_exact_product_identity', transport: 'fixed_shared_background_collector_plus_private_supabase_catalog_and_parent_memory_market_snapshot', batch_mode: 'Gate_full_pagination_6h_Coinbase_full_identity_6h_and_light_market_15m_not_per_user', rate_limit_class: 'slow_shared_reference_catalog', collector: 'stock-catalog-v2-parent', target_layer: 'exchange_asset_catalog', current_integration: 'ready_step1035_14_streaming_catalog_low_memory_restart_fix', fallback_policy: 'persisted_verified_catalog; exact_product_identity_only; missing_market_fields_stay_null', history_policy: 'current_catalog_only', source_url: 'Gate Stock API + Coinbase Advanced Trade Products' },
  ...
  // Binance
  { provider: 'binance', market: 'spot', capability: 'directory', official_available: true, official_scope: 'live_USDT_symbols_observed_by_official_all_market_stream', transport: 'public_market_data_only_WebSocket', batch_mode: 'one_shared_data-stream_miniTicker_arr_changed-symbol_observation', rate_limit_class: 'one_shared_stream_zero_REST_weight', collector: 'market-light-collector', target_layer: 'market_light', current_integration: 'ready_step1031_2_stream_bootstrap', fallback_policy: 'last_verified_stream_snapshot; optional_heavy_REST_baseline_disabled_by_default; no authenticated REST or Edge relay', history_policy: 'none', source_url: 'https://developers.binance.com/en/docs/products/spot/testnet/web-socket-streams' },
  { provider: 'binance', market: 'spot', capability: 'ticker_24h', official_available: true, official_scope: 'live_USDT_symbols_changed_in_official_all_market_stream', transport: 'public_market_data_only_WebSocket', batch_mode: 'one_shared_data-stream_miniTicker_arr_price_open_high_low_base_quote_volume', rate_limit_class: 'one_shared_stream_zero_REST_weight', collector: 'market-light-collector', target_layer: 'market_light', current_integration: 'ready_step1031_2_stream_bootstrap', fallback_policy: 'last_verified_stream_snapshot; no user-scaled REST; no cross-provider substitution', history_policy: 'none', source_url: 'https://developers.binance.com/en/docs/products/spot/testnet/web-socket-streams' },
  { provider: 'binance', market: 'spot', capability: 'bbo', official_available: true, official_scope: 'not_in_miniTicker_stream', transport: 'optional_public_market_data_only_REST_or_exact_market_source', batch_mode: 'market_light_stream_bootstrap_keeps_bbo_null_when_optional_REST_disabled', rate_limit_class: 'optional_not_required_for_market_light_ready', collector: 'market-light-collector', target_layer: 'market_light', current_integration: 'intentional_null_step1031_2_stream_only_default', fallback_policy: 'null_until_verified_official_BBO_source_available; never derive; no cross-provider substitution', history_policy: 'none', source_url: 'https://developers.binance.com/en/docs/products/spot/testnet/web-socket-streams' },
  ...
  { provider: 'okx', market: 'contract', capability: 'instrument_price_limit_ratios', official_available: true, official_scope: 'SWAP_full_directory_init_float_max_price_limit_ratios', transport: 'reuse_existing_public_instruments_REST_batch', batch_mode: 'same_shared_full_directory_zero_additional_request_count', rate_limit_class: 'zero_additional_exchange_request_count', collector: 'market-light-collector', target_layer: 'market_light_product_facts', current_integration: 'ready_step1019', fallback_policy: 'official_empty_stays_null; no derived or cross-provider substitution', history_policy: 'current_directory_snapshot', source_url: 'https://www.okx.com/docs-v5/en/' },
  ...
  { provider: 'okx', market: 'contract', capability: 'rpi_orderbook_current_focus', official_available: true, official_scope: 'focus15_USDT_perpetual_current_20_levels', transport: 'official_books_rpi_REST_shared_background', batch_mode: 'bounded_4_symbols_per_15s_rotation', rate_limit_class: 'shared_bounded_below_official_20_requests_per_2s', collector: 'contract-rpi-shared-deep-market', target_layer: 'official_rpi_overlay', current_integration: 'ready_step1021', fallback_policy: 'last verified until stale then missing; RPI equals official totalQty minus official nonRpiQty at same level; never infer from standard book', history_policy: 'current_only', source_url: 'https://www.okx.com/docs-v5/log_en/' },
  ...
  { provider: 'bybit', market: 'contract', capability: 'single_side_open_interest_current', official_available: true, official_scope: 'linear_and_inverse_ticker_batch_single_side_size_and_value', transport: 'reuse_existing_official_tickers_REST_batch', batch_mode: 'same_shared_category_batch_zero_additional_request_count', rate_limit_class: 'zero_additional_exchange_request_count', collector: 'market-light-collector', target_layer: 'market_light_product_facts', current_integration: 'ready_step1019', fallback_policy: 'official_missing_stays_null; never derive single-side from both-side OI', history_policy: 'current_only', source_url: 'https://bybit-exchange.github.io/docs/v5/market/tickers' },
  ...
  { provider: 'bitget', market: 'contract', capability: 'rpi_orderbook_current_focus', official_available: true, official_scope: 'focus15_USDT_perpetual_current_20_levels', transport: 'official_UTA_rpi_orderbook_REST_shared_background', batch_mode: 'bounded_4_symbols_per_15s_rotation', rate_limit_class: 'shared_bounded_below_official_10_requests_per_second_IP', collector: 'contract-rpi-shared-deep-market', target_layer: 'official_rpi_overlay', current_integration: 'ready_step1021', fallback_policy: 'last verified until stale then missing; use official non-RPI and RPI quantities separately; never infer from standard book', history_policy: 'current_only', source_url: 'https://www.bitget.com/api-doc/uta/public/RPI-OrderBook' },
  ...
  { provider: 'gate', market: 'contract', capability: 'contract_funding_schedule_slippage_circuit_breaker_rules', official_available: true, official_scope: 'full_contract_directory_funding_interval_next_apply_market_order_slip_ratio_enable_circuit_breaker', transport: 'reuse_existing_futures_contracts_REST_batch', batch_mode: 'same_shared_full_directory_zero_additional_request_count', rate_limit_class: 'zero_additional_exchange_request_count', collector: 'market-light-collector', target_layer: 'market_light_product_facts', current_integration: 'ready_step1019', fallback_policy: 'official_empty_stays_null; false is valid; no derived or cross-provider substitution', history_policy: 'current_directory_snapshot', source_url: 'https://www.gate.com/docs/developers/apiv4/en/' },
  ...
  { provider: 'coinbase', market: 'spot', capability: 'product_book_mid_spread_metrics', official_available: true, official_scope: 'active_exact_product_mid_market_spread_bps_spread_absolute', transport: 'authenticated_Advanced_Trade_product_book_REST_plus_existing_public_Level2_WS_fallback', batch_mode: 'background_active_symbols_only_bounded_by_12_existing_Level2_slots', rate_limit_class: 'shared_governed_10s_refresh', collector: 'contract-depth-parent', target_layer: 'spot_orderbook_metrics', current_integration: 'ready_step1022_optional_Render_ECDSA_credentials_enable_official_primary', fallback_policy: 'official fields take precedence; existing same-product official Level2 WS BBO derivation only when official fields unavailable; no cross-product or cross-provider substitution', history_policy: 'current_only', source_url: 'https://docs.cdp.coinbase.com/api-reference/advanced-trade-api/rest-api/public/get-public-product-book' },
...
function registrySnapshot({ includeCapabilities = true } = {}) {
  ...
  const stockCatalogV2 = getStockCatalogV2Health();
  ...
  const payload = {
    ...
    step1032_crypto_sector_professional: {
      ready:
        health?.crypto_sector_professional?.coverage_ready === true &&
        health?.crypto_sector_professional?.source_verified === true &&
        Number(health?.crypto_sector_professional?.sector_count || 0) === 9 &&
        Number(health?.crypto_sector_professional?.healthy_usdt_provider_count || 0) === 5 &&
        health?.crypto_sector_professional?.coinbase_usd_healthy === true &&
        Number(health?.crypto_sector_professional?.six_venue_healthy_count || 0) === 6 &&
        Number(health?.crypto_sector_professional?.exchange_requests_started || 0) === 0 &&
        Number(health?.crypto_sector_professional?.exchange_connections_started || 0) === 0 &&
        Number(health?.crypto_sector_professional?.user_read_upstream_requests || 0) === 0 &&
        Number(health?.crypto_sector_professional?.user_read_upstream_connections || 0) === 0 &&
        health?.crypto_sector_professional?.reads_scale_with_users === false &&
        health?.crypto_sector_professional?.cross_quote_aggregation === false &&
        health?.crypto_sector_professional?.tradeable_index === false &&
        health?.crypto_sector_professional?.fabricated_points === false,
      version: health?.crypto_sector_professional?.version || null,
      data_version: Number(health?.crypto_sector_professional?.data_version || 0),
      schema_version: health?.crypto_sector_professional?.schema_version || null,
      sector_count: Number(health?.crypto_sector_professional?.sector_count || 0),
      active_sector_count: Number(health?.crypto_sector_professional?.active_sector_count || 0),
      observed_unique_asset_count: Number(health?.crypto_sector_professional?.observed_unique_asset_count || 0),
      healthy_usdt_provider_count: Number(health?.crypto_sector_professional?.healthy_usdt_provider_count || 0),
      coinbase_usd_healthy: health?.crypto_sector_professional?.coinbase_usd_healthy === true,
      six_venue_healthy_count: Number(health?.crypto_sector_professional?.six_venue_healthy_count || 0),
      additional_exchange_requests: Number(health?.crypto_sector_professional?.exchange_requests_started || 0),
      additional_exchange_connections: Number(health?.crypto_sector_professional?.exchange_connections_started || 0),
      user_read_upstream_requests: Number(health?.crypto_sector_professional?.user_read_upstream_requests || 0),
      user_read_upstream_connections: Number(health?.crypto_sector_professional?.user_read_upstream_connections || 0),
      reads_scale_with_users: health?.crypto_sector_professional?.reads_scale_with_users === true,
    ...
    step1035_stock_catalog_v2: {
      ready:
        stockCatalogV2?.coverage_ready === true &&
        stockCatalogV2?.background_shared_collector === true &&
        stockCatalogV2?.user_reads_trigger_source_requests === false &&
        stockCatalogV2?.reads_scale_with_users === false &&
        Number(stockCatalogV2?.direct_exchange_requests_from_user_reads || 0) === 0 &&
        Number(stockCatalogV2?.direct_exchange_connections_from_user_reads || 0) === 0 &&
        Number(stockCatalogV2?.gate?.rows || 0) >= Number(stockCatalogV2?.catalog_thresholds?.gate_complete_min_rows || 4000) &&
        stockCatalogV2?.gate?.full_pagination === true &&
        stockCatalogV2?.gate?.hard_old_10_page_cap_removed === true &&
        Number(stockCatalogV2?.coinbase?.product_rows || 0) >= 1000 &&
        Number(stockCatalogV2?.coinbase?.distinct_securities || 0) >= 500 &&
        stockCatalogV2?.coinbase?.full_cursor_pagination === true &&
        stockCatalogV2?.coinbase?.hard_old_6_page_cap_removed === true &&
        stockCatalogV2?.coinbase?.catalog_integrity?.committed_integrity_ready === true &&
        stockCatalogV2?.coinbase?.catalog_integrity?.incomplete_catalog_never_committed === true &&
        ...
        stockCatalogV2?.coinbase_market?.persisted_compact_snapshot === true &&
        ...
        Number(stockCatalogV2?.shared_identity_map_entries || 0) > 0 &&
        stockCatalogV2?.security_identity?.quote_variants_preserved === true &&
      ...
      refresh_interval_minutes: Number(stockCatalogV2?.refresh_interval_minutes || 0),
      coinbase_market_refresh_interval_minutes: Number(stockCatalogV2?.coinbase_market_refresh_interval_minutes || 0),
      coinbase_market_refresh_successes: Number(stockCatalogV2?.coinbase_market?.refresh_successes || 0),
      coinbase_market_refresh_failures: Number(stockCatalogV2?.coinbase_market?.refresh_failures || 0),
      gate_rows: Number(stockCatalogV2?.gate?.rows || 0),
      gate_us_rows: Number(stockCatalogV2?.gate?.us_rows || 0),
      gate_hk_rows: Number(stockCatalogV2?.gate?.hk_rows || 0),
      gate_kr_rows: Number(stockCatalogV2?.gate?.kr_rows || 0),
      gate_chinese_name_rows: Number(stockCatalogV2?.gate?.chinese_name_rows || 0),
      gate_session_refresh_interval_minutes: Number(stockCatalogV2?.gate?.session_refresh_interval_minutes || 0),
      gate_session_refresh_successes: Number(stockCatalogV2?.gate?.session_refresh_successes || 0),
      coinbase_product_rows: Number(stockCatalogV2?.coinbase?.product_rows || 0),
      coinbase_distinct_securities: Number(stockCatalogV2?.coinbase?.distinct_securities || 0),
      coinbase_priced_rows: Number(stockCatalogV2?.coinbase?.priced_rows || 0),
      coinbase_current_session_rows: Number(stockCatalogV2?.coinbase?.current_session_rows || 0),
      coinbase_chinese_name_rows: Number(stockCatalogV2?.coinbase?.chinese_name_rows || 0),
      coinbase_kline_probe: stockCatalogV2?.coinbase?.kline_probe || null,
      user_reads_trigger_source_requests: stockCatalogV2?.user_reads_trigger_source_requests === true,
      reads_scale_with_users: stockCatalogV2?.reads_scale_with_users === true,
      security_identity: stockCatalogV2?.security_identity || null,
      localization: stockCatalogV2?.localization || null,
      session_policy: stockCatalogV2?.session_policy || null,
    },
    binance_spot_step1001_7: {
      ...
      ready: health.binance_spot_ticker_shared_ws?.ready === true &&
        ...
        health.binance_spot_ticker_shared_ws?.stream_connected === true &&
        health.binance_spot_ticker_shared_ws?.stream_bootstrap_enabled === true &&
        health.binance_spot_ticker_shared_ws?.rest_baseline_required_for_ready === false &&
      ...
      rest_baseline_enabled: health.binance_spot_ticker_shared_ws?.rest_baseline_enabled === true,
      rest_baseline_required_for_ready: health.binance_spot_ticker_shared_ws?.rest_baseline_required_for_ready === true,
      stream_bootstrap_enabled: health.binance_spot_ticker_shared_ws?.stream_bootstrap_enabled === true,
      stream_bootstrap_rows: Number(health.binance_spot_ticker_shared_ws?.stream_bootstrap_rows || 0),
    ...
    step1024_official_capability_batch: {
      ...
      bybit_option_historical_volatility_quote_source: 'current_official_option_directory',
    ...
    coinbase_step1022: {
      ready: contractDepth.coinbase_product_book_credentials_configured === true &&
        Number(contractDepth.coinbase_product_book_stats?.successes || 0) > 0 &&
        contractDepth.coinbase_product_book_self_test?.ok === true,
      integration_ready: contractDepth.coinbase_product_book_auth_required === true &&
        contractDepth.coinbase_product_book_official_fields_take_precedence === true &&
        contractDepth.coinbase_product_book_ws_bbo_fallback_only_when_official_missing === true &&
        contractDepth.coinbase_product_book_user_read_starts_rest_request === false &&
        contractDepth.coinbase_product_book_user_count_scales_rest_requests === false &&
        contractDepth.coinbase_product_book_bounded_by_level2_symbol_slots === true &&
        contractDepth.coinbase_product_book_self_test?.ok === true,
      official_credentials_configured:
        contractDepth.coinbase_product_book_credentials_configured === true,
      official_primary_successes:
        Number(contractDepth.coinbase_product_book_stats?.successes || 0),
      official_primary_failures:
        Number(contractDepth.coinbase_product_book_stats?.failures || 0),
      official_primary_last_error:
        String(contractDepth.coinbase_product_book_stats?.last_error || ''),
      official_fields: Array.isArray(contractDepth.coinbase_product_book_official_fields)
        ? [...contractDepth.coinbase_product_book_official_fields]
        : [],
      active_symbol_slot_cap: Number(contractDepth.coinbase_level2_max_symbols || 0),
      user_read_starts_rest_request:
        contractDepth.coinbase_product_book_user_read_starts_rest_request === true,
      user_count_scales_rest_requests:
        contractDepth.coinbase_product_book_user_count_scales_rest_requests === true,
      fallback_source: 'same_product_official_Level2_WS_BBO_only',
      blocked_reason: contractDepth.coinbase_product_book_credentials_configured === true
        ? ''
        : 'render_coinbase_cdp_ecdsa_credentials_not_configured',
    },
    v46_closure: {
...
export function getSourceCapabilityRegistryHealth() {
  ...
  return {
    ...
    ready: payload.business_rules_ready === true &&
      ...
      payload.step1035_stock_catalog_v2.ready &&

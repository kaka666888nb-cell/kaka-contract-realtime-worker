...
async function fetchBinanceJson(url, {
  ...
  // Step650.8.15.10: all Binance public HTTP used by contract flow/meta is relayed
...
async function fetchBinanceMetricRows(state) {
  ...
  // Step650.8.15.10: metrics are requested sequentially under the shared governor.
...
export async function handleContractFlow(req,res,url){
  ...
  if(provider==='binance'){
    // Step650.8.15.10: start the all-account ratio before the OI helper. Both still

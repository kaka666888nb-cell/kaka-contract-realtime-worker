...
const STEP_VERSION = '650.8.15.63';
  ...
  if (url.pathname === '/health') {
    ...
    res.end(JSON.stringify({
      ...
      risk_controls: {
        ...
        gate_spot_second_history_uses_official_from_to: true,
        gate_spot_second_history_strict_end_time_boundary: true,
        gate_spot_second_history_max_pages: 8,
        gate_spot_second_history_window_days: 30,

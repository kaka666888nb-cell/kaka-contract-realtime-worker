...
const STEP_VERSION = '650.8.15.197.3.3.32.1';
...
// Step1041.6.1: Reality stock-token ranking stays unchanged; this hotfix only
// preserves the already-shared memories: hourly Bitget Reality identity catalog in the
...
const server = http.createServer(async (req, res) => {
  ...
  if (url.pathname === '/health') {
    ...
    res.end(JSON.stringify({
      ...
      market_light_data_hub_spot_summary: '/api/market-light/data-hub-spot-summary',

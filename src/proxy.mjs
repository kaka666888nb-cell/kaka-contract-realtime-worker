...
const STEP_VERSION = '650.8.15.196';
...
const server = http.createServer(async (req, res) => {
  ...
  if (url.pathname === '/health') {
    ...
    res.end(JSON.stringify({
      ...
      onchain_holders: '/api/onchain/holders',
      ...
      onchain_overview: '/api/onchain/overview',
